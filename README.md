...
execution:
  --execution-providers {tensorrt,cuda,azure,cpu} [{tensorrt,cuda,azure,cpu} ...]                                    choose from the available execution providers (choices: cpu, ...)
...
frame processors:
  ...
  --face-debugger-items {bbox,kps,paste-back,score} [{bbox,kps,paste-back,score} ...]                                specify debug items (choices: bbox, kps, paste-back, score, ...)
...
(venv) henry@nostromo:~/PycharmProjects/facefusion$ python run.py --help
usage: run.py [-h] [-s SOURCE_PATH] [-t TARGET_PATH] [-o OUTPUT_PATH] [-v] [--skip-download] [--headless] [--execution-providers {tensorrt,cuda,azure,cpu} [{tensorrt,cuda,azure,cpu} ...]] [--execution-thread-count [1-128]] [--execution-queue-count [1-32]] [--max-memory [1-128]] [--face-analyser-order {left-right,right-left,top-bottom,bottom-top,small-large,large-small,best-worst,worst-best}]
              [--face-analyser-age {child,teen,adult,senior}] [--face-analyser-gender {male,female}] [--face-detector-model {retinaface,yunet}] [--face-detector-size {160x160,320x320,480x480,512x512,640x640,768x768,960x960,1024x1024}] [--face-detector-score [0.0-1.0]] [--face-selector-mode {reference,many}] [--reference-face-position REFERENCE_FACE_POSITION] [--reference-face-distance [0.0-1.5]]
              [--reference-frame-number REFERENCE_FRAME_NUMBER] [--face-mask-blur [0.0-1.0]] [--face-mask-padding FACE_MASK_PADDING [FACE_MASK_PADDING ...]] [--trim-frame-start TRIM_FRAME_START] [--trim-frame-end TRIM_FRAME_END] [--temp-frame-format {jpg,png}] [--temp-frame-quality [0-100]] [--keep-temp] [--output-image-quality [0-100]]
              [--output-video-encoder {libx264,libx265,libvpx-vp9,h264_nvenc,hevc_nvenc}] [--output-video-quality [0-100]] [--keep-fps] [--skip-audio] [--frame-processors FRAME_PROCESSORS [FRAME_PROCESSORS ...]] [--face-debugger-items {bbox,kps,paste-back,score} [{bbox,kps,paste-back,score} ...]] [--face-enhancer-model {codeformer,gfpgan_1.2,gfpgan_1.3,gfpgan_1.4,gpen_bfr_256,gpen_bfr_512,restoreformer}]
              [--face-enhancer-blend [0-100]] [--face-swapper-model {blendface_256,inswapper_128,inswapper_128_fp16,simswap_256,simswap_512_unofficial}] [--frame-enhancer-model {real_esrgan_x2plus,real_esrgan_x4plus,real_esrnet_x4plus}] [--frame-enhancer-blend [0-100]] [--ui-layouts UI_LAYOUTS [UI_LAYOUTS ...]]
