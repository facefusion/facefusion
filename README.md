...
This software is meant to be a productive contribution to the rapidly growing AI-generated media industry. It will help artists with tasks such as:
- Animating a custom character
- Using the character as a model for clothing and more.

The developers of this software are aware of its possible unethical applications and are committed to taking preventative measures against them. It includes a built-in check that prevents the program from working on inappropriate media, including but not limited to:
- Nudity
- Graphic content
- Sensitive material like war footage, etc.

We are dedicated to advancing this project in a positive direction while adhering to both legal standards and ethics. In certain circumstances, the project may be shut down or watermarks may be added to the output as required by law.

Users of this software are expected to use it responsibly and in accordance with local laws. If a real person's face is used, users are advised to obtain consent from the individual and clearly indicate that the content is a deepfake when sharing it online. The developers of this software will not be held responsible for the actions of end-users.
