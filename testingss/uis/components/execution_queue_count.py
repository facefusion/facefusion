...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(testingss.choices.execution_queue_count_range),
		minimum = testingss.choices.execution_queue_count_range[0],
		maximum = testingss.choices.execution_queue_count_range[-1]
	)
