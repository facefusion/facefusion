...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(testingss.choices.execution_thread_count_range),
		minimum = testingss.choices.execution_thread_count_range[0],
		maximum = testingss.choices.execution_thread_count_range[-1]
	)
