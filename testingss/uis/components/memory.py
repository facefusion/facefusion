...
from testingss.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = testingss.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(testingss.choices.system_memory_limit_range),
		minimum = testingss.choices.system_memory_limit_range[0],
		maximum = testingss.choices.system_memory_limit_range[-1],
