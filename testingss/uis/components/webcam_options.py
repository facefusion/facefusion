...
from testingss import wording
from testingss.common_helper import get_first
from testingss.uis.components.webcam import get_available_webcam_ids
...
def render() -> None:
	...
	WEBCAM_MODE_RADIO = gradio.Radio(
		...
		choices = testingss.choices.webcam_modes,
		value = 'inline'
	)
	WEBCAM_RESOLUTION_DROPDOWN = gradio.Dropdown(
		label = wording.get('uis.webcam_resolution_dropdown'),
		choices = testingss.choices.webcam_resolutions,
		value = testingss.choices.webcam_resolutions[0]
	)
