...
from testingss import curl_builder, logger, process_manager, state_manager, wording
from testingss.filesystem import get_file_name, get_file_size, is_file, remove_file
from testingss.hash_helper import validate_hash
from testingss.types import Commands, DownloadProvider, DownloadSet
...
def resolve_download_url_by_provider(download_provider : DownloadProvider, base_name : str, file_name : str) -> Optional[str]:
	download_provider_value = testingss.choices.download_provider_set.get(download_provider)
