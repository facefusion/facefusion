...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/testingss/testingss-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/testingss/{base_name}/resolve/main/{file_name}'
	}
}
