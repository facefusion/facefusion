...
from testingss.filesystem import create_directory, get_file_extension, get_file_name, move_file, remove_directory, resolve_file_pattern
...
def get_temp_directory_path(file_path : str) -> str:
	...
	return os.path.join(state_manager.get_item('temp_path'), 'testingss', temp_file_name)
