...
def is_audio(audio_path : str) -> bool:
	return is_file(audio_path) and get_file_format(audio_path) in testingss.choices.audio_formats
...
def is_image(image_path : str) -> bool:
	return is_file(image_path) and get_file_format(image_path) in testingss.choices.image_formats
...
def is_video(video_path : str) -> bool:
	return is_file(video_path) and get_file_format(video_path) in testingss.choices.video_formats
