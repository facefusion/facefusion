...
import testingss.jobs.job_manager
import testingss.jobs.job_store
import testingss.processors.core as processors
from testingss import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, wording
from testingss.common_helper import get_first
from testingss.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from testingss.execution import has_execution_provider
from testingss.face_analyser import get_average_face, get_many_faces, get_one_face
from testingss.face_helper import paste_back, warp_face_by_face_landmark_5
from testingss.face_masker import create_occlusion_mask, create_region_mask, create_static_box_mask
from testingss.face_selector import find_similar_faces, sort_and_filter_faces, sort_faces_by_order
from testingss.face_store import get_reference_faces
from testingss.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from testingss.model_helper import get_static_model_initializer
from testingss.processors import choices as processors_choices
from testingss.processors.pixel_boost import explode_pixel_boost, implode_pixel_boost
from testingss.processors.types import FaceSwapperInputs
from testingss.program_helper import find_argument_group
from testingss.thread_helper import conditional_thread_semaphore
from testingss.types import ApplyStateItem, Args, DownloadScope, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from testingss.vision import read_image, read_static_image, read_static_images, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingss.jobs.job_store.register_step_keys([ 'face_swapper_model', 'face_swapper_pixel_boost' ])
...
def forward_swap_face(source_face : Face, crop_vision_frame : VisionFrame) -> VisionFrame:
	...
	if has_execution_provider('coreml') and model_type in [ 'ghost', 'uniface' ]:
		face_swapper.set_providers([ testingss.choices.execution_provider_set.get('cpu') ])
