...
from testingss import config, content_analyser, inference_manager, logger, process_manager, state_manager, wording
...
from testingss.processors.types import FrameColorizerInputs
from testingss.program_helper import find_argument_group
from testingss.thread_helper import thread_semaphore
from testingss.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from testingss.vision import read_image, read_static_image, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingss.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
