...
from testingss.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from testingss.filesystem import get_file_name, in_directory, is_image, is_video, resolve_file_paths, resolve_relative_path, same_file_extension
from testingss.processors import choices as processors_choices
from testingss.processors.types import DeepSwapperInputs, DeepSwapperMorph
from testingss.program_helper import find_argument_group
from testingss.thread_helper import thread_semaphore
from testingss.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from testingss.vision import conditional_match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingss.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
