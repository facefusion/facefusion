...
from testingss import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, voice_extractor, wording
from testingss.audio import create_empty_audio_frame, get_voice_frame, read_static_voice
...
from testingss.face_helper import create_bounding_box, paste_back, warp_face_by_bounding_box, warp_face_by_face_landmark_5
from testingss.face_masker import create_mouth_mask, create_occlusion_mask, create_static_box_mask
...
from testingss.filesystem import filter_audio_paths, has_audio, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from testingss.processors import choices as processors_choices
from testingss.processors.types import LipSyncerInputs
from testingss.program_helper import find_argument_group
from testingss.thread_helper import conditional_thread_semaphore
from testingss.types import ApplyStateItem, Args, AudioFrame, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from testingss.vision import read_image, read_static_image, restrict_video_fps, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingss.jobs.job_store.register_step_keys([ 'lip_syncer_model' ])
