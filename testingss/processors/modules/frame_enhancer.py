...
from testingss.processors.types import FrameEnhancerInputs
...
from testingss.vision import create_tile_frames, merge_tile_frames, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingss.jobs.job_store.register_step_keys([ 'frame_enhancer_model', 'frame_enhancer_blend' ])
