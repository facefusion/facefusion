...
from testingss.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from testingss.processors.types import AgeModifierDirection, AgeModifierInputs
from testingss.program_helper import find_argument_group
from testingss.thread_helper import thread_semaphore
...
from testingss.vision import match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		testingss.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if has_execution_provider('coreml'):
		age_modifier.set_providers([ testingss.choices.execution_provider_set.get('cpu') ])
