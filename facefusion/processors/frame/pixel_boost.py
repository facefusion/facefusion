...
def implode_pixel_boost(crop_vision_frame : VisionFrame, model_size : Size, pixel_boost_total : int) -> VisionFrame:
...
def explode_pixel_boost(pixel_boost_vision_frame : VisionFrame, model_size : Size, pixel_boost_total, pixel_boost_size : Size) -> VisionFrame:
	crop_vision_frame = numpy.stack(pixel_boost_vision_frame, axis = 0).reshape(pixel_boost_total, pixel_boost_total, model_size[0], model_size[1], 3)
