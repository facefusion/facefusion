...
def register_args(program : ArgumentParser) -> None:
	program.add_argument('--frame-colorizer-model', help = wording.get('help.frame_colorizer_model'), default = config.get_str_value('frame_processors.frame_colorizer_model'), choices = frame_processors_choices.frame_colorizer_models)
	program.add_argument('--frame-colorizer-blend', help = wording.get('help.frame_colorizer_blend'), type = int, default = config.get_int_value('frame_processors.frame_colorizer_blend'), choices = frame_processors_choices.frame_colorizer_blend_range, metavar = create_metavar(frame_processors_choices.frame_colorizer_blend_range))
	program.add_argument('--frame-colorizer-size', help = wording.get('help.frame_colorizer_size'), type = str, default = config.get_str_value('frame_processors.frame_colorizer_size'), choices = frame_processors_choices.frame_colorizer_sizes)
...
def apply_args(program : ArgumentParser) -> None:
	...
	if args.frame_colorizer_blend is not None:
		frame_processors_globals.frame_colorizer_blend = args.frame_colorizer_blend
	if args.frame_colorizer_size is not None:
