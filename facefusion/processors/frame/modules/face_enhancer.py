...
def enhance_face(target_face: Face, temp_frame: Frame) -> Frame:
	...
	crop_mask = create_mask(crop_frame, facefusion.globals.face_mask_types, facefusion.globals.face_mask_blur, (0, 0, 0, 0), facefusion.globals.face_mask_parser_regions)
