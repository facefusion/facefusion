...
def sync_lip(target_face : Face, temp_audio_frame : AudioFrame, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	crop_vision_frame, affine_matrix = warp_face_by_face_landmark_5(temp_vision_frame, target_face.landmarks['5/68'], 'ffhq_512', (512, 512))
	if numpy.any(target_face.landmarks['68']):
		face_landmark_68 = cv2.transform(target_face.landmarks['68'].reshape(1, -1, 2), affine_matrix).reshape(-1, 2)
