...
face_editor_eyebrow_direction_range : List[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_eye_gaze_horizontal_range : List[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_eye_gaze_vertical_range : List[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_eye_open_ratio_range : List[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_lip_open_ratio_range : List[float] = create_float_range(-1.0, 1.0, 0.1)
