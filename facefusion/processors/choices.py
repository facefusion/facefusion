...
face_editor_lip_grim_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_lip_pout_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_lip_purse_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_lip_smile_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_lip_horizontal_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.1)
face_editor_lip_vertical_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.1)
