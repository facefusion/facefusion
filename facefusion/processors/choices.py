...
face_editor_pose_pitch_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.05)
face_editor_pose_yaw_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.05)
face_editor_pose_roll_range : Sequence[float] = create_float_range(-1.0, 1.0, 0.05)
