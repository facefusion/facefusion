	...
	if state_manager.get_item('face_selector_mode') == 'many':
		if many_faces:
			for target_face in many_faces:
				temp_vision_frame = restore_expression(source_vision_frame, target_face, temp_vision_frame)
	...
	if state_manager.get_item('face_selector_mode') == 'reference':
		...
		if similar_faces:
			for similar_face in similar_faces:
				temp_vision_frame = restore_expression(source_vision_frame, similar_face, temp_vision_frame)
	return temp_vision_frame
