...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		group_processors.add_argument('--face-editor-model', help = translator.get('help.model', __package__), default = config.get_str_value('processors', 'face_editor_model', 'live_portrait'), choices = processor_choices.face_editor_models)
		group_processors.add_argument('--face-editor-eyebrow-direction', help = translator.get('help.eyebrow_direction', __package__), type = float, default = config.get_float_value('processors', 'face_editor_eyebrow_direction', '0'), choices = processor_choices.face_editor_eyebrow_direction_range, metavar = create_float_metavar(processor_choices.face_editor_eyebrow_direction_range))
		group_processors.add_argument('--face-editor-eye-gaze-horizontal', help = translator.get('help.eye_gaze_horizontal', __package__), type = float, default = config.get_float_value('processors', 'face_editor_eye_gaze_horizontal', '0'), choices = processor_choices.face_editor_eye_gaze_horizontal_range, metavar = create_float_metavar(processor_choices.face_editor_eye_gaze_horizontal_range))
		...
		group_processors.add_argument('--face-editor-eye-open-ratio', help = translator.get('help.eye_open_ratio', __package__), type = float, default = config.get_float_value('processors', 'face_editor_eye_open_ratio', '0'), choices = processor_choices.face_editor_eye_open_ratio_range, metavar = create_float_metavar(processor_choices.face_editor_eye_open_ratio_range))
		group_processors.add_argument('--face-editor-lip-open-ratio', help = translator.get('help.lip_open_ratio', __package__), type = float, default = config.get_float_value('processors', 'face_editor_lip_open_ratio', '0'), choices = processor_choices.face_editor_lip_open_ratio_range, metavar = create_float_metavar(processor_choices.face_editor_lip_open_ratio_range))
		group_processors.add_argument('--face-editor-mouth-grim', help = translator.get('help.mouth_grim', __package__), type = float, default = config.get_float_value('processors', 'face_editor_mouth_grim', '0'), choices = processor_choices.face_editor_mouth_grim_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_grim_range))
		group_processors.add_argument('--face-editor-mouth-pout', help = translator.get('help.mouth_pout', __package__), type = float, default = config.get_float_value('processors', 'face_editor_mouth_pout', '0'), choices = processor_choices.face_editor_mouth_pout_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_pout_range))
		group_processors.add_argument('--face-editor-mouth-purse', help = translator.get('help.mouth_purse', __package__), type = float, default = config.get_float_value('processors', 'face_editor_mouth_purse', '0'), choices = processor_choices.face_editor_mouth_purse_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_purse_range))
		...
		group_processors.add_argument('--face-editor-head-pitch', help = translator.get('help.head_pitch', __package__), type = float, default = config.get_float_value('processors', 'face_editor_head_pitch', '0'), choices = processor_choices.face_editor_head_pitch_range, metavar = create_float_metavar(processor_choices.face_editor_head_pitch_range))
		group_processors.add_argument('--face-editor-head-yaw', help = translator.get('help.head_yaw', __package__), type = float, default = config.get_float_value('processors', 'face_editor_head_yaw', '0'), choices = processor_choices.face_editor_head_yaw_range, metavar = create_float_metavar(processor_choices.face_editor_head_yaw_range))
		group_processors.add_argument('--face-editor-head-roll', help = translator.get('help.head_roll', __package__), type = float, default = config.get_float_value('processors', 'face_editor_head_roll', '0'), choices = processor_choices.face_editor_head_roll_range, metavar = create_float_metavar(processor_choices.face_editor_head_roll_range))
