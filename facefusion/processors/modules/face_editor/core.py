...
MODULE_SCOPE = 'facefusion.processors.modules.face_editor'
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		group_processors.add_argument('--face-editor-model', help = translator.get('help.model', MODULE_SCOPE), default = config.get_str_value('processors', 'face_editor_model', 'live_portrait'), choices = processor_choices.face_editor_models)
		group_processors.add_argument('--face-editor-eyebrow-direction', help = translator.get('help.eyebrow_direction', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_eyebrow_direction', '0'), choices = processor_choices.face_editor_eyebrow_direction_range, metavar = create_float_metavar(processor_choices.face_editor_eyebrow_direction_range))
		group_processors.add_argument('--face-editor-eye-gaze-horizontal', help = translator.get('help.eye_gaze_horizontal', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_eye_gaze_horizontal', '0'), choices = processor_choices.face_editor_eye_gaze_horizontal_range, metavar = create_float_metavar(processor_choices.face_editor_eye_gaze_horizontal_range))
		group_processors.add_argument('--face-editor-eye-gaze-vertical', help = translator.get('help.eye_gaze_vertical', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_eye_gaze_vertical', '0'), choices = processor_choices.face_editor_eye_gaze_vertical_range, metavar = create_float_metavar(processor_choices.face_editor_eye_gaze_vertical_range))
		group_processors.add_argument('--face-editor-eye-open-ratio', help = translator.get('help.eye_open_ratio', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_eye_open_ratio', '0'), choices = processor_choices.face_editor_eye_open_ratio_range, metavar = create_float_metavar(processor_choices.face_editor_eye_open_ratio_range))
		group_processors.add_argument('--face-editor-lip-open-ratio', help = translator.get('help.lip_open_ratio', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_lip_open_ratio', '0'), choices = processor_choices.face_editor_lip_open_ratio_range, metavar = create_float_metavar(processor_choices.face_editor_lip_open_ratio_range))
		group_processors.add_argument('--face-editor-mouth-grim', help = translator.get('help.mouth_grim', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_mouth_grim', '0'), choices = processor_choices.face_editor_mouth_grim_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_grim_range))
		group_processors.add_argument('--face-editor-mouth-pout', help = translator.get('help.mouth_pout', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_mouth_pout', '0'), choices = processor_choices.face_editor_mouth_pout_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_pout_range))
		group_processors.add_argument('--face-editor-mouth-purse', help = translator.get('help.mouth_purse', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_mouth_purse', '0'), choices = processor_choices.face_editor_mouth_purse_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_purse_range))
		group_processors.add_argument('--face-editor-mouth-smile', help = translator.get('help.mouth_smile', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_mouth_smile', '0'), choices = processor_choices.face_editor_mouth_smile_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_smile_range))
		group_processors.add_argument('--face-editor-mouth-position-horizontal', help = translator.get('help.mouth_position_horizontal', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_mouth_position_horizontal', '0'), choices = processor_choices.face_editor_mouth_position_horizontal_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_position_horizontal_range))
		group_processors.add_argument('--face-editor-mouth-position-vertical', help = translator.get('help.mouth_position_vertical', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_mouth_position_vertical', '0'), choices = processor_choices.face_editor_mouth_position_vertical_range, metavar = create_float_metavar(processor_choices.face_editor_mouth_position_vertical_range))
		group_processors.add_argument('--face-editor-head-pitch', help = translator.get('help.head_pitch', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_head_pitch', '0'), choices = processor_choices.face_editor_head_pitch_range, metavar = create_float_metavar(processor_choices.face_editor_head_pitch_range))
		group_processors.add_argument('--face-editor-head-yaw', help = translator.get('help.head_yaw', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_head_yaw', '0'), choices = processor_choices.face_editor_head_yaw_range, metavar = create_float_metavar(processor_choices.face_editor_head_yaw_range))
		group_processors.add_argument('--face-editor-head-roll', help = translator.get('help.head_roll', MODULE_SCOPE), type = float, default = config.get_float_value('processors', 'face_editor_head_roll', '0'), choices = processor_choices.face_editor_head_roll_range, metavar = create_float_metavar(processor_choices.face_editor_head_roll_range))
