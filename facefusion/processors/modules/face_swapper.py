...
MODEL_SET : ModelSet =\
{
	...
	'ghost_256_unet_1':
	{
		'hashes':
		{
			...
			'embedding_converter':
			{
				'url': 'https://huggingface.co/bluefoxcreation/Embedding-converters/resolve/main/arcface_ghost_converter_w600k_r50.hash',
				'path': resolve_relative_path('../.assets/models/arcface_ghost_converter_w600k_r50.hash')
			}
		},
		'sources':
		{
			...
			'embedding_converter':
			{
				'url': 'https://huggingface.co/bluefoxcreation/Embedding-converters/resolve/main/arcface_ghost_converter_w600k_r50.onnx',
				'path': resolve_relative_path('../.assets/models/arcface_ghost_converter_w600k_r50.onnx')
			}
		},
		'type': 'ghost',
	...
	'simswap_256':
	{
		'hashes':
		{
			...
			'embedding_converter':
			{
				'url': 'https://huggingface.co/bluefoxcreation/Embedding-converters/resolve/main/arcface_simswap_converter_w600k_r50.hash',
				'path': resolve_relative_path('../.assets/models/arcface_simswap_converter_w600k_r50.hash')
			}
		},
		'sources':
		{
			...
			'embedding_converter':
			{
				'url': 'https://huggingface.co/bluefoxcreation/Embedding-converters/resolve/main/arcface_simswap_converter_w600k_r50.onnx',
				'path': resolve_relative_path('../.assets/models/arcface_simswap_converter_w600k_r50.onnx')
			}
		},
		'type': 'simswap',
		'template': 'arcface_112_v1',
