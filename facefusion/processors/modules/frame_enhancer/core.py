		...
		facefusion.capability_store.register_capability_set(
			[
				group_processors.add_argument(
					...
					default = config.get_str_value('processors.frame_enhancer', 'frame_enhancer_model', 'span_kendata_x4'),
				...
				group_processors.add_argument(
					...
					type = int,
					default = config.get_int_value('processors.frame_enhancer', 'frame_enhancer_blend', '80'),
