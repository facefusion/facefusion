		...
		facefusion.capability_store.register_capability_set(
			[
				group_processors.add_argument(
					...
					default = config.get_str_value('processors.deep_swapper', 'deep_swapper_model', 'iperov/elon_musk_224'),
				...
				group_processors.add_argument(
					...
					type = int,
					default = config.get_int_value('processors.deep_swapper', 'deep_swapper_morph', '100'),
