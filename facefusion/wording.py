WORDING =\
{
	...
	'face_detector_model_help': 'specify the model used for face detection',
	'face_detector_size_help': 'specify the size threshold used for face detection',
	'face_detector_score_help': 'specify the score threshold used for face detection',
	'face_selector_mode_help': 'specify the mode for face selection',
	'face_mask_blur_help': 'specify the blur amount for face mask',
	'face_mask_padding_help': 'specify the face mask padding (top, bottom, left, right) for cropping',
	...
	'face_mask_pad_top_slider_label': 'FACE PAD TOP',
	'face_mask_pad_bottom_slider_label': 'FACE PAD BOTTOM',
	'face_mask_pad_left_slider_label': 'FACE PAD LEFT',
	'face_mask_pad_right_slider_label': 'FACE PAD RIGHT',
