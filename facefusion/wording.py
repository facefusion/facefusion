...
WORDING : Dict[str, Any] =\
{
	...
	'help':
	{
		...
		'face_editor_lip_position_horizontal': 'specify the lip position horizontal amount',
		'face_editor_lip_position_vertical': 'specify the lip position vertical amount',
