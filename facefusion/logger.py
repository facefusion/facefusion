...
def debug(message : str, scope : str = 'FACEFUSION.DEBUG') -> None:
	get_package_logger().debug('[' + scope + '] ' + message)


def info(message : str, scope : str = 'FACEFUSION.INFO') -> None:
	get_package_logger().info('[' + scope + '] ' + message)


def warn(message : str, scope : str = 'FACEFUSION.WARN') -> None:
	get_package_logger().warning('[' + scope + '] ' + message)


def error(message : str, scope : str = 'FACEFUSION.ERROR') -> None:
