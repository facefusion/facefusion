...
FaceMaskType = Literal['box', 'occluder', 'parser']
FaceMaskParserRegion = Literal['background', 'skin', 'left-eyebrow', 'right-eyebrow', 'left-eye', 'right-eye', 'eye-glasses', 'left-ear', 'right-ear', 'earring', 'nose', 'mouth', 'upper-lip', 'lower-lip', 'neck', 'necklace', 'cloth', 'hair', 'hat']
