...
def create_config_path_program() -> ArgumentParser:
	...
	args_store.register_job_keys([ 'config_path' ])
...
def create_temp_path_program() -> ArgumentParser:
	...
	args_store.register_job_keys([ 'temp_path' ])
	return program
...
def create_jobs_path_program() -> ArgumentParser:
	...
	args_store.register_job_keys([ 'jobs_path' ])
	return program
...
def create_source_paths_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'source_paths' ])
	return program
...
def create_target_path_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'target_path' ])
	return program
...
def create_output_path_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'output_path' ])
	return program
...
def create_source_pattern_program() -> ArgumentParser:
	...
	args_store.register_job_keys([ 'source_pattern' ])
	return program
...
def create_target_pattern_program() -> ArgumentParser:
	...
	args_store.register_job_keys([ 'target_pattern' ])
	return program
...
def create_output_pattern_program() -> ArgumentParser:
	...
	args_store.register_job_keys([ 'output_pattern' ])
	return program
...
def create_face_detector_program() -> ArgumentParser:
	...
	keys = [ 'face_detector_model', 'face_detector_size', 'face_detector_margin', 'face_detector_angles', 'face_detector_score' ]
	args_store.register_api_keys(keys)
	args_store.register_step_keys(keys)
...
def create_face_landmarker_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'face_landmarker_model', 'face_landmarker_score' ])
	return program
...
def create_face_selector_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'face_selector_mode', 'face_selector_order', 'face_selector_gender', 'face_selector_race', 'face_selector_age_start', 'face_selector_age_end', 'reference_face_position', 'reference_face_distance', 'reference_frame_number' ])
	return program
...
def create_face_masker_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'face_occluder_model', 'face_parser_model', 'face_mask_types', 'face_mask_areas', 'face_mask_regions', 'face_mask_blur', 'face_mask_padding' ])
	return program
...
def create_voice_extractor_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'voice_extractor_model' ])
	return program
...
def create_frame_extraction_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'trim_frame_start', 'trim_frame_end', 'temp_frame_format', 'keep_temp' ])
	return program
...
def create_output_creation_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'output_image_quality', 'output_image_scale', 'output_audio_encoder', 'output_audio_quality', 'output_audio_volume', 'output_video_encoder', 'output_video_preset', 'output_video_quality', 'output_video_scale', 'output_video_fps' ])
	return program
...
def create_processors_program() -> ArgumentParser:
	...
	args_store.register_step_keys([ 'processors' ])
...
def create_download_providers_program() -> ArgumentParser:
	...
	args_store.register_job_keys(['download_providers'])
	return program
...
def create_download_scope_program() -> ArgumentParser:
	...
	args_store.register_job_keys(['download_scope'])
	return program
...
def create_execution_program() -> ArgumentParser:
	...
	args = [ 'execution_device_ids', 'execution_providers', 'execution_thread_count' ]
	args_store.register_api_keys(args)
	args_store.register_job_keys(args)
...
def create_memory_program() -> ArgumentParser:
	...
	args_store.register_job_keys(['video_memory_strategy', 'system_memory_limit'])
	return program
...
def create_log_level_program() -> ArgumentParser:
	...
	args_store.register_job_keys(['log_level'])
	return program
...
def create_halt_on_error_program() -> ArgumentParser:
	...
	args_store.register_job_keys(['halt_on_error'])
	return program
...
def create_job_id_program() -> ArgumentParser:
	...
	args_store.register_job_keys(['job_id'])
	return program
