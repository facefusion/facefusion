...
def create_program() -> ArgumentParser:
	...
	sub_program.add_parser('metrics', help = translator.get('help.metrics'), parents = [ create_temp_path_program(), create_log_level_program() ], formatter_class = create_help_formatter_large)
	# job manager
