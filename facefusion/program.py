...
def create_face_selector_program() -> ArgumentParser:
	...
	group_face_selector.add_argument('--face-tracking', help = translator.get('help.face_tracking'), action = 'store_true', default = config.get_bool_value('face_selector', 'face_tracking')) # TODO-replace with --face-tracker-strategy
