...
from facefusion.typing import FaceSelectorMode, FaceAnalyserOrder, FaceAnalyserAge, FaceAnalyserGender, FaceMaskType, TempFrameFormat, OutputVideoEncoder
...
face_mask_types : List[FaceMaskType] = [ 'box', 'occlution' ]
