...
from facefusion.typing import FaceSelectorMode, FaceAnalyserOrder, FaceAnalyserAge, FaceAnalyserGender, FaceMaskType, FaceMaskParserRegion, TempFrameFormat, OutputVideoEncoder
...
face_mask_types : List[FaceMaskType] = [ 'box', 'occluder', 'parser' ]
face_mask_parser_regions : List[FaceMaskParserRegion] = ['background', 'skin', 'left-eyebrow', 'right-eyebrow', 'left-eye', 'right-eye', 'eye-glasses', 'left-ear', 'right-ear', 'earring', 'nose', 'mouth', 'upper-lip', 'lower-lip', 'neck', 'necklace', 'cloth', 'hair', 'hat']
