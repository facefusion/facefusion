...
face_mask_regions : List[FaceMaskRegion] = [ 'skin', 'right-eyebrow', 'left-eyebrow', 'right-eye', 'left-eye', 'eye-glasses', 'right-ear', 'left-ear', 'nose', 'mouth', 'upper-lip', 'lower-lip' ]
