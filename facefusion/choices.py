...
face_mask_types : List[FaceMaskType] = [ 'box', 'occlution', 'region' ]
face_mask_regions : List[FaceMaskRegion] = [ 'skin', 'left-eyebrow', 'right-eyebrow', 'left-eye', 'right-eye', 'eye-glasses', 'left-ear', 'right-ear', 'earring', 'nose', 'mouth', 'upper-lip', 'lower-lip', 'neck', 'necklace', 'cloth', 'hair', 'hat', 'occlusion' ]
