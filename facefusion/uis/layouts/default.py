...
GRADIO_SHARE = setuptools.distutils.util.strtobool(os.getenv('GRADIO_SHARE'))
...
def run(ui : gradio.Blocks) -> None:
	...
	ui.queue(concurrency_count = concurrency_count).launch(show_api = False, quiet = True, share = GRADIO_SHARE)
