...
from facefusion.uis.components import about, frame_processors, frame_processors_options, execution, \
	execution_thread_count, execution_queue_count, limit_resources, benchmark_options, benchmark
...
def run(ui: gradio.Blocks) -> None:
	...
	ui.queue(concurrency_count=2, api_open=False).launch(show_api=False,server_port=globals.port, server_name=server_name)
