...
def update_face_mask_type(face_mask_types : List[FaceMaskType]) -> Tuple[Update, Update, Update]:
	...
	return gradio.update(value = facefusion.globals.face_mask_types), gradio.update(visible = has_box_mask), gradio.update(visible = has_region_mask)
...
def update_face_mask_regions(face_mask_regions : List[FaceMaskRegion]) -> Update:
	...
	return gradio.update(value = facefusion.globals.face_mask_regions)
