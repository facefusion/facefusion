...
def listen() -> None:
	...
	if output_image and output_video:
		...
		JOB_RUNNER_START_BUTTON.click(process, outputs = [ JOB_RUNNER_START_BUTTON, JOB_RUNNER_STOP_BUTTON, output_image, output_video ])
		JOB_RUNNER_STOP_BUTTON.click(stop, outputs = [ JOB_RUNNER_START_BUTTON, JOB_RUNNER_STOP_BUTTON ])
		JOB_RUNNER_CLEAR_BUTTON.click(clear, outputs = [ output_image, output_video ])
