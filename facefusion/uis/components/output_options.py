...
def remote_update() -> Tuple[Update, Update, Update, Update, Update, Update, Update]:
	if is_image(facefusion.globals.target_path):
		output_image_resolution = detect_image_resolution(facefusion.globals.target_path)
		output_image_resolutions = create_image_resolutions(output_image_resolution)
		facefusion.globals.output_image_resolution = pack_resolution(output_image_resolution)
		return gradio.update(visible = True), gradio.update(visible = True, value = facefusion.globals.output_image_resolution, choices = output_image_resolutions), gradio.update(visible = False), gradio.update(visible = False), gradio.update(visible = False), gradio.update(visible = False, value = None, choices = None), gradio.update(visible = False, value = None)
	if is_video(facefusion.globals.target_path):
		output_video_resolution = detect_video_resolution(facefusion.globals.target_path)
		output_video_resolutions = create_video_resolutions(output_video_resolution)
		...
		return gradio.update(visible = False), gradio.update(visible = False), gradio.update(visible = True), gradio.update(visible = True), gradio.update(visible = True), gradio.update(visible = True, value = facefusion.globals.output_video_resolution, choices = output_video_resolutions), gradio.update(visible = True, value = facefusion.globals.output_video_fps)
	return gradio.update(visible = False), gradio.update(visible = False, value = None, choices = None), gradio.update(visible = False), gradio.update(visible = False), gradio.update(visible = False), gradio.update(visible = False, value = None, choices = None), gradio.update(visible = False, value = None)
