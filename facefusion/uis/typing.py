...
[
	...
	'job_manager_group',
	'job_list_dataframe',
	'job_list_status_checkbox_group',
	'job_list_update_button',
...
JobManagerAction = Literal['job-create', 'job-submit', 'job-submit-all', 'job-delete', 'job-delete-all', 'job-add-step', 'job-remix-step', 'job-insert-step', 'job-remove-step']
