...
job_manager_actions : List[JobManagerAction] = [ 'job-create', 'job-submit', 'job-submit-all', 'job-delete', 'job-delete-all', 'job-list', 'job-add-step', 'job-remix-step', 'job-insert-step', 'job-remove-step' ]
