...
from facefusion.vision import create_static_frame_pack, pack_resolution, read_image, read_static_images, read_video_frame, restrict_image_resolution, restrict_trim_frame, restrict_video_fps, restrict_video_resolution, unpack_resolution, write_image
...
def process_temp_frame(temp_frame_path : str, frame_number : int, temp_frame_paths : List[str]) -> bool:
	...
	target_vision_frames = create_static_frame_pack(temp_frame_paths, frame_number)
	temp_vision_frame = target_vision_frame.copy()
