...
from facefusion.apis.endpoints.assets import delete_asset, get_asset, list_assets, upload_assets
...
def create_api() -> Starlette:
	...
	routes =\
		[
			...
			Route('/assets', list_assets, methods = [ 'GET' ], middleware = [ session_guard ]),
