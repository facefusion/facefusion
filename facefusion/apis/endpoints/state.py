...
async def get_state(request : Request) -> JSONResponse:
	api_args = args_store.filter_api_argument_set(state_manager.get_state())
...
async def set_state(request : Request) -> JSONResponse:
	...
	__api_args__ = args_store.filter_api_argument_set(state_manager.get_state()) #type:ignore[arg-type]
