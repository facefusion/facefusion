...
from facefusion.vision import detect_video_resolution, has_alpha_channel, merge_vision_frame_mask, pack_resolution, read_static_alpha_image, read_static_images, read_static_video_frame, restrict_trim_frame, restrict_video_fps, restrict_video_resolution, scale_resolution, separate_vision_frame_mask, write_image
...
def process_temp_frame(temp_frame_path : str, frame_number : int) -> bool:
	...
	target_vision_mask = None

	if has_alpha_channel(target_vision_frame):
	...
	for processor_module in get_processors_modules(state_manager.get_item('processors')):
		...
		if has_alpha_channel(temp_vision_frame):
