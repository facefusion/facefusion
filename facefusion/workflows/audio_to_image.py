...
from facefusion.audio import count_audio_frame_total, create_empty_audio_frame, get_audio_frame, get_voice_frame, restrict_trim_audio_frame
from facefusion.common_helper import get_first
from facefusion.filesystem import filter_audio_paths, is_video
from facefusion.processors.core import get_processors_modules
from facefusion.temp_helper import get_temp_frame_sequence_paths, move_temp_file
from facefusion.time_helper import calculate_end_time
from facefusion.types import ErrorCode
from facefusion.vision import conditional_merge_vision_mask, detect_image_resolution, extract_vision_mask, pack_resolution, read_static_image, read_static_images, scale_resolution, write_image
...
def process_image() -> ErrorCode:
	state_manager.set_item('output_video_fps', 25.0) # TODO: should i set this as default?
	source_audio_path = get_first(filter_audio_paths(state_manager.get_item('source_paths')))
	audio_frame_total = count_audio_frame_total(source_audio_path, state_manager.get_item('output_video_fps'))
...
def merge_frames() -> ErrorCode:
	...
	if ffmpeg.merge_video(state_manager.get_item('target_path'), state_manager.get_item('output_video_fps'), output_video_resolution, trim_frame_start, trim_frame_end):
