...
def create_temp_frames() -> ErrorCode:
	temp_fps = state_manager.get_item('temp_fps')
	...
	trim_frame_start, trim_frame_end = restrict_trim_audio_frame(source_audio_path, temp_fps, state_manager.get_item('trim_frame_start'), state_manager.get_item('trim_frame_end'))

	if ffmpeg.spawn_frames(state_manager.get_item('target_path'), state_manager.get_item('output_path'), temp_image_resolution, temp_fps, trim_frame_start, trim_frame_end):
