...
LOCALES : Locales =\
{
	'en':
	{
		...
		'metrics':
		{
			...
			'video_memory': 'video memory: {free}/{total} {unit} free',
			'temperature': 'temperature: {value} {unit}',
			'utilization': 'utilization: {value} {unit}',
			'total': 'total: {value} {unit}',
			'free': 'free: {value} {unit}'
		},
		'point': '.',
		'comma': ',',
		'colon': ':',
		...
		'help':
		{
			...
			'metrics': 'print current system and device metrics',
