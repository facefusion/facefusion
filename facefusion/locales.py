...
LOCALES : Locales =\
{
	'en':
	{
		...
		'job_all_pruned': 'jobs pruned',
		'job_all_not_pruned': 'jobs not pruned',
		...
		'help':
		{
			...
			'job_statuses': 'specify the job statuses',
			'job_age': 'specify the minimum job age in hours to prune',
			'step_index': 'specify the step index',
			'job_list': 'list jobs by statuses',
			...
			'job_prune': 'delete jobs by statuses that are older than the job age',
			'job_delete': 'delete a drafted, queued, failed or completed job',
			'job_delete_all': 'delete all jobs by statuses',
