...
LOCALES : Locales =\
{
	'en':
	{
		...
		'help':
		{
			...
			'face_tracker_score': 'specify the minimum overlap score to track a face across frames or set to 0 to disable',
			...
			'target_frame_amount': 'specify the amount of frames to process before and after the target frame',
