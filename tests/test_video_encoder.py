...
def test_encode_vpx() -> None:
	...
	assert encode_vpx(codec_context, yuv_buffer, 320, 240, 1, 0)
	assert encode_vpx(codec_context, yuv_buffer, 320, 240, 3, 1)
	assert encode_vpx(codec_context, bytes(640 * 480 * 3 // 2), 640, 480, 0, 0) == b''
