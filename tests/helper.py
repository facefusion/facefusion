...
from weyfusion.filesystem import create_directory, is_directory, is_file, remove_directory
from weyfusion.typing import JobStatus
...
def get_test_jobs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'weyfusion-test-jobs')
...
def get_test_examples_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'weyfusion-test-examples')
...
def get_test_outputs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'weyfusion-test-outputs')
