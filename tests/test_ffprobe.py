...
def test_detect_audio_sample_rate() -> None:
	...
	assert detect_audio_sample_rate(get_test_example_file('source.wav')) == 48000
...
def test_detect_audio_channel_total() -> None:
	...
	assert detect_audio_channel_total(get_test_example_file('source.wav')) == 2
...
def test_detect_audio_frame_total() -> None:
	...
	assert detect_audio_frame_total(get_test_example_file('source.wav')) == 91200
