...
def test_normalize_output_path() -> None:
	if platform.system().lower() != 'windows':
		...
		assert normalize_output_path('.assets/examples/source.jpg', '.assets/examples/target-240p.mp4', '.assets/examples/valid.mp4') == '.assets/examples/valid.mp4'
		assert normalize_output_path('.assets/examples/source.jpg', '.assets/examples/target-240p.mp4', '.assets/invalid.mov') == '.assets/invalid.mp4'
	assert normalize_output_path('.assets/examples/source.jpg', '.assets/examples/target-240p.mp4', '.assets/examples/invalid') is None
	assert normalize_output_path('.assets/examples/source.jpg', '.assets/examples/target-240p.mp4', '.assets/invalid/valid.mp4') is None
