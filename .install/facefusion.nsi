...
Section 'Create Install Batch'
	...
	${If} $UseCuda == 1
		FileWrite $1 '@echo off && conda activate facefusion && conda install nvidia::cuda-toolkit=12.4.1 cudnn=8.9.2.26 conda-forge::gputil=1.4.0 conda-forge::zlib-wapi --yes'
