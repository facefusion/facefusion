...
from weyfusion.typing import DownloadScope, DownloadSet, FaceLandmark68, FaceMaskRegion, InferencePool, Mask, ModelSet, Padding, VisionFrame
...
def create_region_mask(crop_vision_frame : VisionFrame, face_mask_regions : List[FaceMaskRegion]) -> Mask:
	...
	region_mask = numpy.isin(region_mask.argmax(0), [ weyfusion.choices.face_mask_region_set.get(face_mask_region) for face_mask_region in face_mask_regions ])
