...
from weyfusion.typing import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = weyfusion.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(weyfusion.choices.system_memory_limit_range),
		minimum = weyfusion.choices.system_memory_limit_range[0],
		maximum = weyfusion.choices.system_memory_limit_range[-1],
