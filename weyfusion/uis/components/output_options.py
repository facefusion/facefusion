...
from weyfusion.typing import Fps, OutputAudioEncoder, OutputVideoEncoder, OutputVideoPreset
from weyfusion.uis.core import get_ui_components, register_ui_component
from weyfusion.vision import create_image_resolutions, create_video_resolutions, detect_image_resolution, detect_video_fps, detect_video_resolution, pack_resolution
...
def render() -> None:
	...
	OUTPUT_IMAGE_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(weyfusion.choices.output_image_quality_range),
		minimum = weyfusion.choices.output_image_quality_range[0],
		maximum = weyfusion.choices.output_image_quality_range[-1],
	...
	OUTPUT_AUDIO_ENCODER_DROPDOWN = gradio.Dropdown(
		...
		choices = weyfusion.choices.output_audio_encoders,
	...
	OUTPUT_VIDEO_ENCODER_DROPDOWN = gradio.Dropdown(
		...
		choices = weyfusion.choices.output_video_encoders,
	...
	OUTPUT_VIDEO_PRESET_DROPDOWN = gradio.Dropdown(
		...
		choices = weyfusion.choices.output_video_presets,
	...
	OUTPUT_VIDEO_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(weyfusion.choices.output_video_quality_range),
		minimum = weyfusion.choices.output_video_quality_range[0],
		maximum = weyfusion.choices.output_video_quality_range[-1],
		visible = is_video(state_manager.get_item('target_path'))
	)
