...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(weyfusion.choices.execution_thread_count_range),
		minimum = weyfusion.choices.execution_thread_count_range[0],
		maximum = weyfusion.choices.execution_thread_count_range[-1]
	)
