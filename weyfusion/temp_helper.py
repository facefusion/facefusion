...
from weyfusion.filesystem import create_directory, move_file, remove_directory, resolve_file_pattern
...
def get_temp_directory_path(file_path : str) -> str:
	...
	return os.path.join(state_manager.get_item('temp_path'), 'weyfusion', temp_file_name)
