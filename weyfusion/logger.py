...
from weyfusion.typing import LogLevel, TableContents, TableHeaders


def init(log_level : LogLevel) -> None:
	basicConfig(format = '%(message)s')
	get_package_logger().setLevel(weyfusion.choices.log_level_set.get(log_level))


def get_package_logger() -> Logger:
	return getLogger('weyfusion')
